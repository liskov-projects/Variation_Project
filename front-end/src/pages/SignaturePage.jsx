                    ...
                    <div className="col-md-4 mb-3">
                      <div className="border rounded p-3 bg-light h-100">
                        ...
                        <h4 className="mb-0 text-success">
                          {formatCurrency(currentContractPrice)}
                        </h4>
              ...
              <div className="card border-warning">
                ...
                <div className="card-body">
                  <div className="alert alert-info">
                    ...
                    <p className="mb-0">
                      By signing below, you acknowledge that you have reviewed the variation details above 
                      and approve the additional cost of <strong>{formatCurrency(variation.cost)}</strong> 
                  ...
                  <form onSubmit={handleSubmitSignature}>
                    <div className="mb-3">
                      ...
                      <div className="form-text">
                        Your name will be recorded as your electronic signature with timestamp and IP address.
                      </div>
                    </div>
                      ...
                      <div className="form-check">
                        ...
                        <label className="form-check-label" htmlFor="agreementCheck">
                          ...
                          <ul className="mt-2 mb-0">
                            ...
                            <li>I understand this will increase the total contract price to {formatCurrency(contractPriceWithVariation)}</li>
