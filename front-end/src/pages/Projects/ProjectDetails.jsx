          ...
          <div className="card-body">
            {(!currentProject.variations || currentProject.variations.length === 0) ? (
              <div className="text-center py-4">
                <i className="bi bi-clipboard-plus" style={{ fontSize: '3rem', color: '#ccc' }}></i>
                  ...
                  <tbody>
                    {currentProject.variations.map(variation => (
                      ...
                      >
                        ...
                        <td>{formatCurrency(variation.newContractPrice || 0)}</td>
                        <td>{formatDate(variation.dateCreated)}</td>
                        <td>
                          <span className={`badge ${getVariationStatusBadgeClass(variation.status)}`}>
