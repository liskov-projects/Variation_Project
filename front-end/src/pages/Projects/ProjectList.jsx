            ...
            {projects.length === 0 ? (
              <div className="card">
                <div className="card-body text-center py-5">
                  <i className="bi bi-house" style={{ fontSize: '3rem', color: '#ccc' }}></i>
              ...
              <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                  ...
                  <div className="modal-body">
                    ...
                    <p className="text-danger">This action cannot be undone and will delete all associated variations.</p>
                  </div>
