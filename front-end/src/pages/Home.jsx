          ...
          <div className="row align-items-center">
            <div className="col-lg-8 text-white">
              ...
              <p
                ...
                Empowering businesses with next-generation solutions for the digital era.
              </p>
        ...
        <div className="container">
          <div className="row g-5">
            ...
            <div className="col-lg-6">
              ...
              <p
                className="lead mb-4"
                style={{ color: "#34495E", fontSize: "1.2rem" }}>
                We're not just another company - we're your partner in digital transformation. Our
                innovative approach combines cutting-edge technology with creative solutions.
              </p>
            ...
            <div className="col-lg-6">
              ...
              <p
                className="lead mb-4"
                style={{ color: "#34495E", fontSize: "1.2rem" }}>
                Our company is dedicated to providing top-notch services and solutions to our
                clients. We believe in the power of innovation and strive to stay ahead of the curve
                in the ever-evolving tech landscape.
              </p>
              <p
                className="lead mb-4"
                style={{ color: "#34495E", fontSize: "1.2rem" }}>
                Our team of experts is passionate about delivering excellence and ensuring customer
                satisfaction. We work closely with our clients to understand their unique needs and
                tailor our services to meet their specific requirements.
              </p>
              <p
                className="lead"
                style={{ color: "#34495E", fontSize: "1.2rem" }}>
                ...
                <div className="row align-items-center">
                  <div className="col-lg-6 text-white">
                    ...
                    <p className="lead mb-4">
                      Ready to transform your business? We're here to help you take the next step.
                    </p>
                  </div>
