              ...
              <ProfileProvider>
                <ProjectProvider>
                  <Routes>
                    ...
                    />
                    <Route
                      path="/projects/:projectId/variations/new"
                      element={
                        <PrivateRoute>
                          <VariationCreate />
                        </PrivateRoute>
                    ...
                    />
                    <Route
                      path="/projects/:projectId/variations/start"
                      element={
                        <PrivateRoute>
                          <VariationLogicTree />
                        </PrivateRoute>
                    ...
                    />
                    <Route
                      path="/projects/:projectId/variations/:variationId"
                      element={
                        <PrivateRoute>
                          <ProjectVariation />
                        </PrivateRoute>
                    ...
                    />
                    <Route
                      path="/projects/:projectId/variations/:variationId/edit"
                      element={
                        <PrivateRoute>
                          <VariationEdit />
                        </PrivateRoute>
