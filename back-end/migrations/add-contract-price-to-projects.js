  ...
  try {
    ...
    for (const project of projectsWithoutContractPrice) {
      try {
        ...
        await project.save();
        console.log(`Updated project ${project._id} - contractPrice: ${project.contractPrice}, currentContractPrice: ${project.currentContractPrice}`);
      } catch (error) {
...
async function migrateWithPrompt() {
  try {
    ...
    for (const project of projectsWithoutContractPrice) {
      ...
      await project.save();
      console.log(`Set contractPrice to ${contractPrice}, currentContractPrice to ${project.currentContractPrice}`);
    }
